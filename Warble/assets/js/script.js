...
function showOptionsMenu(button) {
	  var songId = $(button).prevAll(".songId").val();
		...
		var scrollTop = $(window).scrollTop; //distance from window top to top of document
...
function formatTime(seconds) {
		...
		var minutes = Math.floor(time / 60); //Rounds the decimal value down
		var seconds = time - minutes * 60;

//adds an extra 0 if seconds is less than 10. So no 4.3 or 5.6
		var extraZero;
...
//keeps track of song that is currently playing
